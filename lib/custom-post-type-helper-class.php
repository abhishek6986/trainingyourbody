...
class Custom_Post_Type
	{
				...
				if( ! taxonomy_exists( $taxonomy_name ) ){
						...
						//Capitilize the words and make it plural
							...
							$args = array_merge(
	  						...
	  						register_taxonomy( $name, $this->post_type_name, $args );
					...
					else
					{
						...
						//add_action( 'init',array( &$this, 'register_taxonomy_object'));
					}
			}
		}
		...
		public function save()
		{
			...
			add_action( 'save_post',array( &$this, 'save_custom_post_type'));
		}
		
public function register_meta_boxes($box_id, $box_title, $post_type_name, $box_context, $box_priority, $fields)
						{				
							add_meta_box(
								$box_id,
								$box_title,'cb_function_metabox_save',
								$post_type_name,
								$box_context,
								$box_priority,
								array( $fields )
...
public function save_custom_post_type($post_type_name)
				{
...
public function cb_function_metabox_save( $post, $data )
{
	global $post;
